 ...
 */
export type StructuredElement = HeadingElement | ParagraphElement | TextRunElement | CodeBlockElement | PageBreakElement | DividerElement | TableElement | ImageElement | ChartElement | ShapeElement | ListElement | ContainerElement;
/**
 * Element type discriminator.
 */
export type ElementType = 'heading' | 'paragraph' | 'text-run' | 'code-block' | 'page-break' | 'divider' | 'table' | 'image' | 'chart' | 'shape' | 'list' | 'container';
/**
 ...
 */
export type ShapeType = 'rectangle' | 'ellipse' | 'triangle' | 'diamond' | 'pentagon' | 'hexagon' | 'star' | 'arrow' | 'line' | 'custom';
/**
 * List element (ul/ol).
 */

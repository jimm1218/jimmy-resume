/**
 * Minimal structural interfaces mirroring @paperjsx/json-to-pptx's PaperDocument types.
 *
 * Uses TypeScript structural subtyping so any real PaperDocument from
 * @paperjsx/json-to-pptx is assignable without casting or importing core.
 */
...
export type PaperNodeInput = PaperTextNode | PaperViewNode | PaperImageNode | PaperTableNode | PaperChartNode | PaperGroupNode | PaperConnectorNode | PaperVideoNode | PaperAudioNode;

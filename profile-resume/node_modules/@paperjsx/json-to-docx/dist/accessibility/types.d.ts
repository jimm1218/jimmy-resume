 ...
 */
import type { AccessibilityIssue, AccessibilityReport as CanonicalAccessibilityReport, AccessibilitySummary as CanonicalAccessibilitySummary } from "./protocol.js";
export type AccessibilityLevel = 'A' | 'AA' | 'AAA';
export type DocxAccessibilityViolationCode = 'HEADING_SKIP' | 'IMG_ALT_MISSING' | 'IMG_ALT_EMPTY' | 'TABLE_HEADER_MISSING' | 'TABLE_CAPTION_MISSING' | 'DOC_TITLE_MISSING' | 'DOC_LANG_MISSING' | 'LIST_SEMANTIC_MISSING' | 'CONTRAST_INSUFFICIENT';

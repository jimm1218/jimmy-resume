 ...
 */
export type PolyglotNodeType = 'document' | 'page' | 'block' | 'text' | 'heading' | 'paragraph' | 'image' | 'table' | 'row' | 'cell' | 'list' | 'list-item' | 'chart' | 'shape' | 'fragment';
/**

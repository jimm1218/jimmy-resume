...
export type PdfPhase3Size = "A4" | "Letter" | "a4" | "letter" | {
    height: number;
    width: number;
};
...
export type PdfPhase3Node = PdfPhase3ContainerNode | PdfPhase3DividerNode | PdfPhase3HeadingNode | PdfPhase3PageBreakNode | PdfPhase3ParagraphNode | PdfPhase3PreformattedNode;
...
//# sourceMappingURL=phase3-types.d.ts.map
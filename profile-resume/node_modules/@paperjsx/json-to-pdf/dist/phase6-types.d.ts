...
export type PdfPhase6DocumentNode = PdfDocumentLayoutNode | PdfPhase6CheckboxNode | PdfPhase6DropdownNode | PdfPhase6HighlightAnnotationNode | PdfPhase6NoteAnnotationNode | PdfPhase6RadioButtonNode | PdfPhase6SignatureFieldNode | PdfPhase6TextFieldNode | PdfPhase6TocNode;
...
export type PdfDynamicHeaderFooterConfiguredContent = PdfDynamicHeaderFooterContent | PdfDynamicHeaderFooterZones;
...
export declare function isPdfPhase6SpecialNode(node: PdfPhase6DocumentNode): node is Exclude<PdfPhase6DocumentNode, PdfDocumentLayoutNode>;
export declare function hasPhase6Link(value: PdfPhase3Link | undefined): boolean;
//# sourceMappingURL=phase6-types.d.ts.map
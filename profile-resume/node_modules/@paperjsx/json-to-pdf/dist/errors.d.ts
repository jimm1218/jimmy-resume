/**
 * Structured errors for @paperjsx/json-to-pdf.
 *
 * Every error thrown by the engine that isn't a license-tier issue
 * (PaperJSXFeatureError lives in @paperjsx/license) carries a stable
...
export declare function isPdfError(value: unknown): value is PdfError;
